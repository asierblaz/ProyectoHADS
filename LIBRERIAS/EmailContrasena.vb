...
Public Class EmailContrasena
    Public Function emailContrasena(email As String, cod As String) As Boolean
        ...
        Try
            ...
            message.Body = "<html><head></head><body>" + "Estimado usuario, <br> Para restablecer su contraseña  " + "<a href='http://localhost:50322/FormCambioPass.aspx?email=" + email + "&cod=" + cod + "'>Haga Click Aqui</a></body></html>"
            'este es el mensaje para la nube
            '  message.Body = "<html><head></head><body>" + "Estimado <u>" + nombre + "</u>, <br> Para finalizar su registro  " + "<a href='http://hads2020g19.azurewebsites.net/FormCambioPass.aspx?email=" + email + "&cod=" + cod + "'>Haga Click Aqui</a></body></html>"
